...
public class Constants implements ConstantConfigurer {
	...
	public static String		PDF2PNG					= null;
	public static String		PDF2TEXT				= null;
	...
	public void loadProperties(Properties properties) {
		...
		String pdf2png = properties.getProperty("pdf2png");
		if (pdf2png != null) {
			PDF2PNG = pdf2png;
		}
		String pdf2text = properties.getProperty("pdf2text");
		if (pdf2text != null) {
			PDF2TEXT = pdf2text;
		}
