...
public class CommonsMultipartHandler extends CommonsFileUploadSupport implements
		ServletContextAware {
	...
	public void cleanupMultipart(MultipartHttpServletRequest request) {
		if (request != null) {
			try {
				...
				logger.warn(
						"Failed to perform multipart cleanup for servlet request",
						ex);
			}
		}
	}
	...
	// protected List<FileItem> paseRequest(ServletFileUpload fileUpload,
