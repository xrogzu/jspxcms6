...
public class QuestionController {
	...
	public String list(
			@PageableDefaults(sort = { "creationDate", "id" }, sortDir = Direction.DESC) Pageable pageable,
			HttpServletRequest request, org.springframework.ui.Model modelMap) {
		Map<String, String[]> params = Servlets.getParameterValuesMap(request,
				Constants.SEARCH_PREFIX);
		Page<Question> pagedList = service.findAll(params, pageable);
	...
	public String edit(
		...
		Map<String, String[]> params = Servlets.getParameterValuesMap(request,
				Constants.SEARCH_PREFIX);
		RowSide<Question> side = service.findSide(params, bean, position,
				pageable.getSort());
		modelMap.addAttribute("bean", bean);
	...
	public String save(Question bean, Integer[] orgIds, String[] itemTitle,
			Boolean[] itemEssay, String redirect, HttpServletRequest request,
			RedirectAttributes ra) {
		Integer siteId = Context.getCurrentSiteId(request);
		System.out.println(itemTitle);
		service.save(bean, orgIds, itemTitle, itemEssay, siteId);
	...
	public String update(@ModelAttribute("bean") Question bean,
			Integer[] orgIds, Integer[] itemId, String[] itemTitle,
			Boolean[] itemEssay, Integer position, String redirect,
			HttpServletRequest request, RedirectAttributes ra) {
		service.update(bean, orgIds, itemId, itemTitle, itemEssay);
